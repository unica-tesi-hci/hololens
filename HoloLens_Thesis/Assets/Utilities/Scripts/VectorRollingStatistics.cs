...
/// <summary>
    ...
    public class VectorRollingStatistics
    {
        ...
        public void AddSample(Vector3 value)
        {
            ...
            cumulativeFrameSquared -= Vector3.Scale(oldSample, oldSample);

            // Add the new sample to the accumulation
            samples[currentSampleIndex] = value;
            cumulativeFrame += value;
            cumulativeFrameSquared += Vector3.Scale(value, value);
            ...
            float newStandardDev = Mathf.Sqrt((cumulativeFrameSquared / ActualSampleCount - Vector3.Scale(Average, Average)).magnitude);
