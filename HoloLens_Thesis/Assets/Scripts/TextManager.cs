...
//    private bool flag;
//    //
//    private String _adviceTextText = "";
//    private Quaternion adviceTextTransformRotation;
//    private Vector3 backgroundTransformLocalScale;
//    private Bounds trBounds = new Bounds();
//    private String parTextText = "";
...
//    {
//        //modifica 
//        adviceText.text = _adviceTextText;
//        trBounds = textRenderer.bounds;
//        parametersText.text = parTextText;
//        stageText.text = sText;
...
//    {
//        //adviceText.transform.rotation = DefaultRotation;      ERRORE
//        adviceTextTransformRotation = DefaultRotation;

//        textBounds = new Bounds(Vector3.zero, Vector3.zero);
//        textBounds.Encapsulate(trBounds);
//        //background.transform.localScale = new Vector3(textRenderer.bounds.size.x + 0.02f, textRenderer.bounds.size.y, 0.1f);      ERRORE
//        backgroundTransformLocalScale = new Vector3(trBounds.size.x + 0.02f, trBounds.size.y, 0.1f);

//        //defaultTextScale = adviceText.transform.localScale;
//        defaultBackgroundScale = backgroundTransformLocalScale;
//    }
